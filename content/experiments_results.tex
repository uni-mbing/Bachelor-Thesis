...
\begin{figure}[h!]
 ...
 \caption{2D Plot results for increasing $\gamma$ above the definition area keeping the remaining parameters constant; left: tumor cell density, middle: ECM concentration, right: MDE concentration}
