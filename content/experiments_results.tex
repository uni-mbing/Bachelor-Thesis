...
In these experiments an important observation is that the most cruical variable in the system is the tumor cell density. They control not only the motility of the MDEs, but they are also responsible for producing them. The shape of their curve determines also the shape of the MDE curve and along with the production rate they control how many MDEs are being produced. This impacts the ECM concentration as well with the rate at which they are degraded.

This in part explains why exactly those parameters needed adjustments to replicate the results, but it is also worth regarding the remaining parameters of the system. Arguing with the following Parameter Analyses, or with algebraic hypothes, gives information about their importance. 
