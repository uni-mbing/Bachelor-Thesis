...
\begin{figure}[h!]
 ...
 \caption{Plot results for varying $\mu_1$ keeping the other parameters constant}
...
\begin{figure}[h!]
 ...
 \caption{Plot results for varying $\mu_2$ keeping the other parameters constant}
...
\begin{figure}[ht!]
    ...
    \caption{Plot results for varying $\mu_1, \mu_2$ keeping the other parameters constant}
...
\begin{figure}[ht!]
    ...
    \caption{Plot results for varying $d_c,\gamma,\mu_1$ keeping the other parameters constant}
...
\begin{figure}[h!]
    ...
    \caption{Plot results for varying $\eta,\mu_2$ keeping the other parameters constant}
