...
For all the plots of the experiments, the red curve indicates the tumor cell density, the blue curve the ECM density, and the green curve the MDE concentration. In all experiments, we used the value of $\epsilon = 0.01$ to match the initial conditions from \cite{anderson_mathematical_2000} and \cite{Kolev2010}.  
