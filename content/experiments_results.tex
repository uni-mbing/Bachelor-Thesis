...
\end{figure}
As see in figure~\ref{fig:prolif_mu_2_variation}, this renewal process takes some time to show effects, but after $t=8$ the initial assumptions are confirmed, however only in a minor . There are no deviations for the experiments after $t=0.4$.
